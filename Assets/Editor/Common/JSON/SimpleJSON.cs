...
namespace SimpleJSON
{
			...
			while (i < aJSON.Length)
			{
				...
				case '\\':
					...
					if (QuoteMode)
					{
						...
						switch (C)
						{
                            case 't': /*Token += '\t'*/Token.Append('\t'); break;
                            case 'r': /*Token += '\r';*/Token.Append('\r'); break;
                            case 'n': /*Token += '\n';*/Token.Append('\n'); break;
                            case 'b': /*Token += '\b';*/Token.Append('\b'); break;
                            case 'f': /*Token += '\f';*/Token.Append('\f'); break;
						case 'u':
						{
                        ...
                        default: /*Token += C;*/Token.Append(C); break;
						}
					}
					break;
	...
	public class JSONClass : JSONNode, IEnumerable
	{
		...
		public override string ToString(string aPrefix)
        {
			...
			foreach (KeyValuePair<string, JSONNode> N in m_Dict)
			{
                ...
                sb.Append(Escape(N.Key));
                sb.Append("\" : ");
                sb.Append(N.Value.ToString(aPrefix + "   "));
	...
	{
        public static StringBuilder _jsonSB = new StringBuilder();
        public static StringBuilder jsonSB
        {
            get
            {
                _jsonSB.Length = 0;
